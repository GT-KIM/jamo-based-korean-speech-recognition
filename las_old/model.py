...
from .ops import TimeDistributed, CreateOnehotVariable
import numpy as np

class pBLSTMLayer(nn.Module) :
    def __init__(self, input_feature_dim, hidden_dim, rnn_unit='LSTM', dropout_rate=0.1) :
...
class Listener(nn.Module) :
    def __init__(self, input_feature_dim, listener_hidden_dim, listener_layer, rnn_unit,
                 use_gpu, dropout_rate=0.1, **kwargs) :
        ...
        for i in range(1, self.listener_layer) :
            setattr(self, 'pLSTM_layer'+str(i), pBLSTMLayer(input_feature_dim, listener_hidden_dim, rnn_unit=rnn_unit,
                                        dropout_rate=dropout_rate))
